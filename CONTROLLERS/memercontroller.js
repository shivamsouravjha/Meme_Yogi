...
const ChangeMemer = async (req, res, next) => {
    ...
    memerexisting.memername=memername?memername:memerexisting.memername;
    memerexisting.username = username?username:memerexisting.username;
    memerexisting.email = email?email:memerexisting.email;
    memerexisting.password=password?password:memerexisting.password;
    ...
    memerexisting.about=about?about:memerexisting.about;
    try {
